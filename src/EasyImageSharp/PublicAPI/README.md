...
```
EasyImageSharp.Metadata.TiffMetadata.BigTiff.get -> bool
const EasyImageSharp.Formats.DecoderOptions.DefaultMaxTotalPixels = 1073741824 -> long
static EasyImageSharp.Image.Load(string! path) -> EasyImageSharp.Image!
```
...
```
warning RS0016: Symbol 'EasyImageSharp.Metadata.TiffMetadata.BigTiff.get -> bool' is not part of the declared public API
```
...
apicompat --strict-mode \
  --left  <unpacked-nupkg>/lib/<tfm>/EasyImageSharp.dll \
  --right src/EasyImageSharp/bin/Release/<tfm>/EasyImageSharp.dll
```
