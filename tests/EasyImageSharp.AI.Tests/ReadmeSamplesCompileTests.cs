...
/// <summary>
/// Every code sample in this package's README (and every AI sample in the repository README),
/// transcribed verbatim apart from the wrapping method.
...
public class ReadmeSamplesCompileTests
{
    ...
    // Repository README, "Supply chain" section.
    private static void CoreReadmeOptions()
    {
    ...
    // Repository README, "EasyImageSharp.AI — pre-wired models" section.
    private static void CoreReadmeQuickStart()
    {
        using var ai = new ImageAiSession();
        using Image<Rgb24> page = Image.Load<Rgb24>("phone-photo.jpg");
